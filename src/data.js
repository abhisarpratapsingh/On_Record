...
export const initialRecords = [
  { id: 'bank-01', category: 'money', kind: 'Bank account', title: 'Family savings account', institution: 'State Bank of India', reference: 'OR-DEMO-BANK-001', location: 'Blue folder · home study', note: 'Passbook listed in family papers.', nomineeStatus: 'missing', nomineeName: '', nomineeRelation: '', nomineeReviewed: '', process: { authority: 'Your bank, under RBI deceased-depositor guidance', action: 'Deceased-depositor claim', href: 'https://www.rbi.org.in/Scripts/NotificationUser.aspx?Id=9862', note: 'Eligible claims should be settled within 15 days of proof of death and identification.' } },
  { id: 'property-01', category: 'property', kind: 'Property record', title: 'Family home', institution: 'Residential property file', reference: 'OR-DEMO-LAND-001', location: 'Parent’s document file', note: 'Mutation status needs checking.', nomineeStatus: 'na', nomineeName: '', nomineeRelation: '', nomineeReviewed: '', process: { authority: 'State revenue office / sub-registrar', action: 'Mutation and transfer', href: '', note: 'Process varies by state. Confirm locally before relying on this record.' } },
  { id: 'insurance-01', category: 'money', kind: 'Insurance policy', title: 'Life cover policy', institution: 'LIC', reference: 'OR-DEMO-LIFE-001', location: 'Blue folder · policy section', note: 'Policy paper available.', nomineeStatus: 'current', nomineeName: 'Arjun Sharma', nomineeRelation: 'Son', nomineeReviewed: '2025', process: { authority: 'The insurer named on the policy', action: 'Death claim', href: '', note: 'Ask the insurer for its claim form and document list.' } },
  { id: 'shares-01', category: 'money', kind: 'Shares / demat', title: 'Long-term holdings', institution: 'HDFC Securities', reference: 'OR-DEMO-DEM-014', location: 'Digital investment folder', note: 'Nomination should be reviewed after life events.', nomineeStatus: 'review', nomineeName: 'Ananya Sharma', nomineeRelation: 'Spouse', nomineeReviewed: '2021', process: { authority: 'Depository participant, under SEBI transmission rules', action: 'Transmission of securities', href: 'https://www.sebi.gov.in/sebi_data/faqfiles/jan-2026/1767611333081.pdf', note: 'SEBI publishes the transmission FAQ and required documents.' } },
  { id: 'pf-01', category: 'money', kind: 'Provident fund', title: 'Provident fund account', institution: 'EPFO', reference: 'OR-DEMO-PF-208', location: 'Employment records · 2024', note: 'Nominee is a minor; check the institution process.', nomineeStatus: 'minor', nomineeName: 'Kabir Sharma', nomineeRelation: 'Son', nomineeReviewed: '2024', process: { authority: 'EPFO', action: 'Claim by nominee or legal heir', href: 'https://www.epfindia.gov.in/site_en/WhichClaimForm.php', note: 'A minor nominee changes which form applies. Check before filing.' } },
  { id: 'documents-01', category: 'documents', kind: 'Document set', title: 'Family certificates', institution: 'Home records', reference: 'OR-DEMO-DOC-032', location: 'Red file · top shelf', note: 'Death and birth certificates are stored together.', nomineeStatus: 'na', nomineeName: '', nomineeRelation: '', nomineeReviewed: '', process: { authority: 'Issuing authority for each certificate', action: 'Certified copies', href: '', note: 'Municipal or registrar office that issued the original.' } },
  { id: 'wishes-01', category: 'wishes', kind: 'Continuity note', title: 'What to find first', institution: 'Owner-authored note', reference: 'OR-DEMO-WISH-006', location: 'On Record · private', note: 'Call Ananya first. Start with the blue folder and the property file.', nomineeStatus: 'na', nomineeName: '', nomineeRelation: '', nomineeReviewed: '', process: { authority: '', action: '', href: '', note: 'An owner-authored note. It carries no official process.' } },
];
...
export const cloneSeed = () => ({ records: structuredClone(initialRecords), grants: { ...initialGrants }, events: structuredClone(initialEvents), concerns: {}, pendingDowngrades: {}, clockOffset: 0, handover: { recipient: 'ananya', selected: ['property-01', 'insurance-01', 'documents-01'], released: false } });
